...
| ~~**8. Hardening**~~ ✅            | Auditoria de RLS automatizada (34 verificações), `job_health()`, exportação e exclusão de dados do titular, tela de conta                                                                      | feito   |

**Todas as fases concluídas.** O produto está funcional: login, mercado com 151
ativos da B3, compra e venda com custos reais, renda fixa com acruamento por
dia útil, histórico de patrimônio, ranking por temporada, painel admin e
